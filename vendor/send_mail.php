...
if (isset($_GET['mail'])) {
   ...
   if($getActionURI ==="request") {
	  ...
	  $smtp_host        = 'volaresoft.com';                    // Enter the smtp server address you got from your hosting here
	  $smtp_port        = 465;                                 // TCP port to connect to
	  $smtp_username    = 'emirhan.aydemir@volaresoft.com';           // SMTP username
	  $smtp_password    = 'Ea3515217320';                        // SMTP password
      ...
      try {
         ...
         $mail->addAddress("emirhan.aydemir@volaresoft.com");            // Enter the email address you want to send here
